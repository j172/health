...
export const RSS_FEEDS: FeedConfig[] = [
  ...
  },
  {
    code: "wegetcare_blog",
    name: "潮健康 (WeGetCare)",
    url: "https://www.wegetcare.tw/blog-feed.xml",
  ...
  },
  {
    code: "grinews_life",
    name: "草根影響力－生活",
    url: "https://grinews.com/news/category/life/feed/",
    sourceName: "grinews",
    skipDetailFetch: true,
  },
  {
    code: "grinews_health",
    name: "草根影響力－健康",
    url: "https://grinews.com/news/category/health/feed/",
    sourceName: "grinews",
    skipDetailFetch: true,
  },
  {
    code: "ettoday_pet",
    name: "ETtoday 寵物雲",
    url: "https://feeds.feedburner.com/ettoday/pet",
    sourceName: "ettoday",
    skipDetailFetch: true,
  },
  {
    code: "ettoday_health",
    name: "ETtoday 健康雲",
    url: "https://feeds.feedburner.com/ettoday/health",
    sourceName: "ettoday",
    skipDetailFetch: true,
  },
  {
    code: "ncl_fmevents",
    name: "國家圖書館－藝文活動",
    url: "https://web.ncl.edu.tw/event/FMEvents/Rss",
    sourceName: "ncl",
