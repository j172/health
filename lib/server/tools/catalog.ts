...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        question: "資料來源與更新頻率？",
        answer:
          "本站紫外線資料同步自交通部中央氣象署全台各地面氣象觀測站即時監測數據，每小時自動連線校對最新數值。",
      },
    ],
  },
  {
    ...
    directAnswer:
      "本站即時整合中央氣象署 (CWA) 與美國地質調查局 (USGS) 測報，提供近 7 天全台 M4.0+ 與全球 M6.0+ 顯著強震、震源深度與海嘯警報 (Tsunami Warning) 即時資訊。",
    scientificBasis: [
      {
        title: "地震觀測與海嘯警報發布標準",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "台灣地區 M4.0 以上、經中央氣象署發布地震報告的事件會個別顯示；非台灣地區則以全球 M6.0（芮氏規模 6.0）以上的顯著地震為主，能量巨大且影響範圍廣，優先提供即時防災參考。",
      },
      {
        question: "海嘯警報標籤代表什麼？",
        answer:
  ...
  },
  {
    ...
    directAnswer:
      "依 2023 歐洲高血壓學會（ESH）與台灣高血壓學會標準：收縮壓 < 120 且舒張壓 < 80 mmHg 為最佳血壓；≥ 140/90 mmHg 為高血壓。建議採居家 722 原則連續量測取平均值。",
    scientificBasis: [
      {
        title:
      ...
      {
        title: "2022 台灣高血壓指引與居家 722 血壓量測規範",
        authority: "台灣高血壓學會 (THS) / 中華民國心臟學會 (TSOC)",
        url: "https://www.hpa.gov.tw",
      },
    ],
    referenceTable: {
  ...
  },
  {
    ...
    directAnswer:
      "即時連線環境部全台監測站，提供 AQI 指標與 PM2.5/PM10 濃度。分級：0-50 良好（綠）、51-100 普通（黃）、101-150 對敏感族群不健康（橘）、151-200 對所有族群不健康（紅）。",
    scientificBasis: [
      {
    ...
    faqs: [
      ...
      },
      {
        question: "資料來源是哪裡？",
        answer:
          "資料來自環境部（環保署）全台各監測站的即時空氣品質觀測資料，每小時定期自動同步更新。",
      },
    ],
  },
  {
    ...
    directAnswer:
      "即時查詢全台近 2 萬家健保特約醫療院所（醫學中心、區域醫院、地區醫院、基層診所），支援關鍵字、科別、縣市與 GPS 距離定位。",
    scientificBasis: [
      {
  ...
  },
  {
    ...
    directAnswer:
      "查詢全台 8,000+ 家一般藥局與健保特約藥局，支援慢性病連續處方箋調劑藥局篩選與附近 GPS 定位。",
    scientificBasis: [
      {
  ...
  },
  {
    ...
    directAnswer:
      "查詢衛福部食藥署食品營養成分資料庫，分析千種台灣常見食品與食材之熱量、蛋白質、脂肪、碳水化合物及微量元素含量。",
    scientificBasis: [
      {
        title: "台灣食品營養成分資料庫 (FDA Food Composition Database)",
        authority: "衛生福利部食品藥物管理署 (TFDA)",
        url: "https://www.fda.gov.tw",
      },
    ],
    ...
    faqs: [
      ...
      },
      {
        question: "資料來源是什麼？",
        answer:
          "資料來源為衛福部食藥署「食品營養成分資料庫」，收錄台灣常見食品的實測分析數據，每半年更新一次。",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "登錄字號是食品業者依食品安全衛生管理法完成「食品業者登錄平台」登錄後取得的唯一識別碼，用於追溯業者登錄狀態。",
      },
      {
        question: "查不到某業者代表什麼？",
        answer:
    ...
    faqs: [
      {
        ...
        answer:
          "資料來源為衛福部社會及家庭署開放資料「全國身心障礙福利機構一覽表」，涵蓋全台各類身心障礙福利服務機構。",
      },
    ],
  },
  {
    ...
    directAnswer:
      "查詢全台信用合作社提供輪椅可及或視障語音導引服務之無障礙 ATM 自動櫃員機服務據點。",
    scientificBasis: [
      {
  ...
  },
  {
    ...
    description:
      "整合衛生福利部疾病管制署「近12個月登革熱病媒蚊調查資料」，於地圖上查詢全台村里級布氏指數 (BI)、住宅指數 (HI)、容器指數 (CI)、幼蟲指數 (LI) 與成蟲指數 (AI)，並提供官方分級對照說明。",
    directAnswer:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "本站每日同步一次疾病管制署「近12個月登革熱病媒蚊調查資料」，地圖僅顯示每一村里最近一次的調查結果（非每日全面普查，部分村里可能已一段時間未被重新調查）。資料涵蓋全國有進行病媒蚊密度調查之村里，非全台每一村里皆有資料。",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "法定哺集乳室通常具備洗手台、冷熱飲水設備、沙發或哺育椅、電源插座（供電動吸乳器使用）、尿布台及緊急求救鈴等安全與衛生設備。",
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "本頁收錄之藥局均參與台灣婦產科醫學會衛教計畫，藥師受過常規與緊急避孕衛教專業培訓，能提供去污名化、保密的避孕指導並協助評估是否需轉介婦產科醫師。",
      },
      {
  ...
  },
  {
    ...
    directAnswer:
      "台灣中油公告牌價涵蓋 92/95/98 無鉛汽油、超級柴油與家用天然氣等全品項，每週日公布新週油價、每月初調整天然氣與瓦斯牌價。",
    scientificBasis: [
      {
        title: "台灣中油各項油品與氣品參考牌價開放資料",
        authority: "台灣中油股份有限公司 (CPC)",
  ...
  },
  {
    ...
    directAnswer:
      "中油加油站多功能服務地圖整合全台 600 多座自營與加盟站點，支援洗車、充換電、打氣加水、來速咖啡與電子票證等多維度服務即時篩選與導航。",
    scientificBasis: [
      {
