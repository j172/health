...
test("freeway_news is registered in RSS_FEEDS (migrated from the retired gov-opendata pipeline, issue #355)", () => {
...
test("Phase 3: parseTheNewsLensHtml parses media cards", () => {
  const tnlHtml = `
    <div class="articles">
