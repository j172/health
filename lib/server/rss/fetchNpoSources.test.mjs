...
const { parseYmdToUtc, fetchApatwNews, fetchSeinsightsNews } = await import("./fetchNpoSources.ts");

test("NPO: fetchApatwNews and fetchSeinsightsNews are exported and are functions", () => {
...
test("NPO: SOURCE_CATEGORIES contains 'npo' (公益社福) category with all required sources including apatw and seinsights", () => {
