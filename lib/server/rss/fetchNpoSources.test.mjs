...
const { parseYmdToUtc, fetchApatwNews } = await import("./fetchNpoSources.ts");

test("NPO: fetchApatwNews is exported and is a function", () => {
...
test("NPO: SOURCE_CATEGORIES contains 'npo' (公益社福) category with all required sources including apatw", () => {
