...
const { parseYmdToUtc, fetchApatwNews, fetchSeinsightsNews, fetchMygopenNews } = await import("./fetchNpoSources.ts");

test("NPO: fetchApatwNews, fetchSeinsightsNews, and fetchMygopenNews are exported and are functions", () => {
