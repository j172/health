...
export const fetchBusinessweeklyHealthNews =
  async (): Promise<BusinessweeklyHealthFetchResult> => {
    ...
    if (!anyOk) {
      return {
        ...
        items: [],
        errorMessage:
          errors.join("; ") || "Unknown businessweekly health fetch error",
      };
    }
