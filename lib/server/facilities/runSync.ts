...
// (pharmacies, drugs, health-checks, etc.), each behind its own fetch function.
const SOURCES: { key: string; fetch: () => Promise<FacilityRecord[]> }[] = [{ key: "kcg_home_care", fetch: fetchKcgLongTermCareHome }];
