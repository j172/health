...
const COMMON_HOSPITAL_PATTERNS: { regex: RegExp; searchName: string }[] = [
  { regex: /台大醫院|臺大醫院|臺灣大學醫學院附設醫院/g, searchName: "國立臺灣大學醫學院附設醫院" },
  { regex: /台北榮總|臺北榮總|榮民總醫院|中榮|高榮/g, searchName: "榮民總醫院" },
  { regex: /林口長庚|高雄長庚|基隆長庚|長庚醫院|長庚紀念醫院/g, searchName: "長庚醫療財團法人" },
  { regex: /成大醫院|成功大學醫學院附設醫院/g, searchName: "國立成功大學醫學院附設醫院" },
  { regex: /三軍總醫院|三總/g, searchName: "三軍總醫院" },
  { regex: /馬偕醫院|馬偕紀念醫院/g, searchName: "馬偕紀念醫院" },
  { regex: /新光醫院|新光吳火獅紀念醫院/g, searchName: "新光醫療財團法人新光吳火獅紀念醫院" },
  { regex: /國泰醫院|國泰綜合醫院/g, searchName: "國泰醫療財團法人國泰綜合醫院" },
  { regex: /亞東醫院|亞東紀念醫院/g, searchName: "醫療財團法人徐元智先生醫藥基金會亞東紀念醫院" },
  { regex: /雙和醫院|雙和/g, searchName: "衛生福利部雙和醫院" },
  { regex: /慈濟醫院|慈濟綜合醫院/g, searchName: "佛教慈濟醫療財團法人" },
  { regex: /彰基|彰化基督教醫院/g, searchName: "彰化基督教醫療財團法人彰化基督教醫院" },
  { regex: /奇美醫院|奇美醫療/g, searchName: "奇美醫療財團法人奇美醫院" },
  { regex: /振興醫院/g, searchName: "振興醫療財團法人振興醫院" },
  { regex: /萬芳醫院/g, searchName: "臺北市立萬芳醫院" },
  { regex: /和平醫院|聯合醫院和平院區/g, searchName: "臺北市立聯合醫院和平院區" },
  { regex: /仁愛醫院|聯合醫院仁愛院區/g, searchName: "臺北市立聯合醫院仁愛院區" },
  { regex: /中興醫院|聯合醫院中興院區/g, searchName: "臺北市立聯合醫院中興院區" },
  { regex: /陽明醫院|聯合醫院陽明院區/g, searchName: "臺北市立聯合醫院陽明院區" },
  { regex: /忠孝醫院|聯合醫院忠孝院區/g, searchName: "臺北市立聯合醫院忠孝院區" },
  { regex: /童綜合醫院/g, searchName: "童綜合醫療社團法人童綜合醫院" },
  { regex: /秀傳醫院/g, searchName: "秀傳醫療社團法人秀傳紀念醫院" },
  { regex: /部立桃園醫院|衛福部桃園醫院/g, searchName: "衛生福利部桃園醫院" },
  { regex: /部立台中醫院|衛福部台中醫院/g, searchName: "衛生福利部臺中醫院" },
  { regex: /部立台南醫院|衛福部台南醫院/g, searchName: "衛生福利部臺南醫院" },
  { regex: /部立花蓮醫院|衛福部花蓮醫院/g, searchName: "衛生福利部花蓮醫院" },
  { regex: /部立台東醫院|衛福部台東醫院/g, searchName: "衛生福利部臺東醫院" },
  { regex: /部立基隆醫院|衛福部基隆醫院/g, searchName: "衛生福利部基隆醫院" },
  { regex: /部立台北醫院|衛福部台北醫院/g, searchName: "衛生福利部臺北醫院" },
];
