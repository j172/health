...
export const metadata: Metadata = {
  title: "台灣與全球顯著地震查詢 | 即時地震與海嘯動態",
  description: "即時查詢近7天全台 M4.0+ 與全球 M6.0+ 顯著地震資訊，包含震央地點、芮氏規模、震源深度、海嘯警報提示與中央氣象署 (CWA) / USGS 聯合測報。",
  keywords: ["地震", "顯著地震", "地震查詢", "海嘯警報", "USGS", "CWA", "氣象署"],
  alternates: { canonical },
  openGraph: {
    title: "台灣與全球顯著地震查詢 | 即時地震與海嘯動態",
    description: "即時查詢近7天全台 M4.0+ 與全球 M6.0+ 顯著地震資訊，包含震央地點、芮氏規模與海嘯警報提示。",
    url: canonical,
  },
};

export default async function EarthquakesPage() {
  const earthquakes = await getTieredEarthquakes(168, 100);
