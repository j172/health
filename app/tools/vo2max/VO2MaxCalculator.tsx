...
const VO2_STANDARDS = [
  { label: "非常優秀", male: "≥ 55", female: "≥ 49", color: "bg-green-200 text-green-800" },
  { label: "優秀", male: "46 – 54", female: "40 – 48", color: "bg-green-100 text-green-700" },
  { label: "良好", male: "38 – 45", female: "32 – 39", color: "bg-blue-100 text-blue-700" },
  { label: "一般", male: "30 – 37", female: "24 – 31", color: "bg-yellow-100 text-yellow-700" },
  { label: "偏低", male: "< 30", female: "< 24", color: "bg-red-100 text-red-600" },
];
...
export default function VO2MaxCalculator() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="mb-2 text-3xl font-bold text-neutral-800 md:text-4xl">🫁 VO2Max 估算器</h1>
        <p className="text-neutral-600">輸入年齡、安靜心率，以安靜心率法 (Uth 公式) 快速估算您的最大攝氧量，評估心肺耐力等級。</p>
      </div>
      ...
      <div className={cardClass}>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="vo2-age" className="mb-1.5 block text-sm font-medium text-neutral-700">
              年齡
            </label>
            <div className="relative">
              ...
              />
              <span className="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-neutral-500">歲</span>
            </div>
          </div>

          <div>
            <label htmlFor="vo2-hrrest" className="mb-1.5 block text-sm font-medium text-neutral-700">
              安靜心率
            </label>
            <div className="relative">
              <input
              ...
              />
              <span className="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-neutral-500">bpm</span>
            </div>
            <p className="mt-1 text-xs text-neutral-500">早晨起床前，靜臥測量 1 分鐘</p>
          </div>
        </div>
        ...
        <div className={cardClass}>
          ...
          <div className="grid grid-cols-2 gap-4 text-center">
            ...
            <div className="rounded-none bg-neutral-50 p-5">
              ...
              <p className="mt-1 text-xs text-neutral-500">Tanaka 公式</p>
            </div>
          </div>
      ...
      <div className={cardClass}>
        <h2 className="mb-4 text-xl font-bold text-neutral-800">VO2Max 等級對照（ACSM 標準，mL/kg/min）</h2>
      ...
      <div className={`space-y-2 text-sm text-neutral-600 ${cardClass}`}>
        <h3 className="text-base font-semibold text-neutral-800">如何正確測量安靜心率？</h3>
