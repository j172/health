...
export default function StressAssessment() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="mb-2 text-3xl font-bold text-neutral-800 md:text-4xl">🧠 壓力評估測驗</h1>
        ...
        <div className="space-y-4">
          <div className={`${result.bgColor} space-y-3 rounded-xl border border-neutral-200 p-5`}>
            ...
            <div className="relative mb-4 mt-2 h-3 rounded-full bg-gradient-to-r from-green-400 via-yellow-400 to-red-500">
              <div
                className="absolute top-1/2 h-4 w-4 -translate-y-1/2 rounded-full border-2 border-neutral-400 bg-white shadow transition-all"
            ...
            <p className="pt-1 text-sm text-neutral-800">{result.description}</p>

            <div className="space-y-1.5 pt-1">
              <p className="text-sm font-medium text-neutral-800">建議應對策略：</p>
