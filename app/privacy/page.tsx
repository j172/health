    ...
    <>
      ...
      <div className="min-h-screen bg-white text-neutral-800 dark:bg-slate-900 dark:text-slate-100">
        ...
        <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
          <nav className="mb-6 text-sm text-neutral-500 dark:text-slate-400" aria-label="breadcrumb">
          ...
          <div className="space-y-8 text-sm leading-relaxed text-neutral-700 dark:text-slate-300">
            ...
            <section className="space-y-2">
              <h2 className="text-xl font-semibold text-neutral-800 dark:text-slate-100">一、本站蒐集哪些資料</h2>
            ...
            <section className="space-y-2">
              <h2 className="text-xl font-semibold text-neutral-800 dark:text-slate-100">三、資料保存期間</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-xl font-semibold text-neutral-800 dark:text-slate-100">四、您的權利</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-xl font-semibold text-neutral-800 dark:text-slate-100">五、兒童隱私</h2>
              <p>本站內容以一般大眾為對象，並非特別針對兒童設計，亦不會刻意向兒童蒐集個人資料。</p>
            </section>

            <section className="space-y-2">
              <h2 className="text-xl font-semibold text-neutral-800 dark:text-slate-100">六、政策更新</h2>
              <p>本政策可能因法規異動或站內功能調整而更新，更新後將標示於本頁上方的「最後更新日期」，請不定期回來查看。</p>
            </section>

            <section className="space-y-2">
              <h2 className="text-xl font-semibold text-neutral-800 dark:text-slate-100">七、聯絡我們</h2>
              <p>
