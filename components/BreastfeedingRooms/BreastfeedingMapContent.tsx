...
export default function BreastfeedingMapContent() {
  ...
  return (
    <div className="space-y-4">
      ...
      <MapLocationBanner location={location} facilityTypeName="哺集乳室" />
      ...
      {viewMode === "map" ? (
        <div className="relative h-[65vh] min-h-[450px] w-full overflow-hidden rounded-2xl border border-neutral-200 dark:border-slate-800">
          <button
            ...
            className="absolute right-3 top-3 z-[1000] flex items-center gap-1.5 rounded-lg bg-white/95 px-3 py-2 text-xs font-bold text-pink-700 shadow-md backdrop-blur-xs transition hover:bg-white active:scale-95 dark:bg-slate-900/95 dark:text-pink-300 border border-slate-200 dark:border-slate-800 disabled:opacity-50"
